      ...
      <div>
        ...
        <div style="margin: 20px auto; width: 1200px">
          ...
          <p>
            ...
            2. 编辑模式 EDITOR 普通编辑模式（固定 label
            控件，只允许对区域控件、非只读控件操作），该模式下的 toolbar
            只能对控件里面的元素起作用，对 label
            不起作用-》【只对label做限制】<br />
            3. 严格模式 STRICT
            （只允许对文档段及控件修改-》门诊），执行严格模板。也就是表单模式<br />
